      ...
      <main>
        <section className=''>
          <div className='layout min-h-screen py-20'>
            ...
            <div className='mt-8'>
              <Typography as='h1' variant='d1'>
                Display 1 <span className='italic'>Display 1</span>
              </Typography>
              <Typography as='h1' variant='d2'>
                Display 2 <span className='italic'>Display 2</span>
              </Typography>
            ...
            <div className='mt-8'>
              <Typography variant='h1' as='h1' color='base'>
                Base
              </Typography>
            ...
            <div className='mt-8'>
              <Typography
                ...
                className='h3 sm:h2 md:h1 lg:d1'
              >
                Responsive
              </Typography>
            </div>
